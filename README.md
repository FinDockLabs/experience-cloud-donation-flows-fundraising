...
2. Assign the **FinDock Experience Cloud Guest Access** permission set to your Experience Cloud site guest user. It grants access to the `Donation_Flow`, `One_Screen_Donation_Flow` and `Contact_Assignment` flows and the `CurrencyPickerController` Apex class.
